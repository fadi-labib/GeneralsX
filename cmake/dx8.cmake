...
if(EMSCRIPTEN)
  ...
  # Platform seam stub: dx8wasm's device.cpp calls platform::{create,destroy,
  # present,alive}_gl_context. The real impl (platform_sdl3.cpp) creates its own
  # SDL GL context, which must be reconciled with the engine's SDL3 context - a
  # runtime concern (next plan). For the M3 link we satisfy the symbols with
  # no-ops so the .wasm links (it won't render yet).
  set(_dx8_stub ${CMAKE_BINARY_DIR}/dx8wasm_platform_stub.cpp)
  file(WRITE ${_dx8_stub}
"// Generated by cmake/dx8.cmake - dx8wasm platform seam stub for the M3 link.\n"
"// Real GL-context reconciliation (engine SDL3 <-> dx8wasm) is the runtime plan.\n"
"namespace platform {\n"
"bool create_gl_context(int, int) { return false; }\n"
"void present() {}\n"
"void destroy_gl_context() {}\n"
"bool gl_context_alive() { return false; }\n"
"}\n"
"\n"
...
"// pulls in. Provide a no-op for the M3 link (busy-poll semantics; the caller\n"
"// re-checks the predicate). Threading correctness is a runtime concern.\n"
"#include <cstdint>\n"
